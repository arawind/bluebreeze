...
function bones_scripts_and_styles() {
  if (!is_admin()) {
    ...
    wp_register_style( 'bones-css', get_stylesheet_directory_uri(). '/style.css', array('bones-stylesheet'), '', 'all');
    wp_register_script( 'bones-css1', get_stylesheet_directory_uri() . 'bones-styleshee', array(), '2.5.3', false );
