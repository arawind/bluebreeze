...
<section id="respond" class="respond-form">
	...
	<ul id="comment-form-elements" class="clearfix">
		...
		<li>
<p>		  <label for="author"><?php _e("Name", "bonestheme"); ?> <?php if ($req) echo "(required)"; ?></label></p>
<p>		  <input type="text" name="author" id="author" value="<?php echo esc_attr($comment_author); ?>" placeholder="<?php _e('Your Name*', 'bonestheme'); ?>" tabindex="1" <?php if ($req) echo "aria-required='true'"; ?> /></p>
		</li>
		
		<li>
<p>		  <label for="email"><?php _e("Mail", "bonestheme"); ?> <?php if ($req) echo "(required)"; ?></label></p>
<p>		  <input type="email" name="email" id="email" value="<?php echo esc_attr($comment_author_email); ?>" placeholder="<?php _e('Your E-Mail*', 'bonestheme'); ?>" tabindex="2" <?php if ($req) echo "aria-required='true'"; ?> /></p>
		  <p><small><?php _e("(will not be published)", "bonestheme"); ?></small></p>
		</li>
		
		<li>
		  <p><label for="url"><?php _e("Website", "bonestheme"); ?></label></p>
		  <p><input type="url" name="url" id="url" value="<?php echo esc_attr($comment_author_url); ?>" placeholder="<?php _e('Got a website?', 'bonestheme'); ?>" tabindex="3" /></p>
		</li>
